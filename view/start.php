...
ob_start();
?>
<h1 style="display: flex; justify-content: center;">Последние фильмы</h1>

<?php if (empty($arr)): ?>
  <p>Пока нет фильмов в базе.</p>
<?php else: ?>
  <div class="movie-grid">
    <?php foreach (array_slice($arr, 0, 6) as $m): ?>
      <?php
        $id = (int)($m['id'] ?? 0);
  ...
  <div style="margin-top:20px; display: flex; justify-content: center;">
    <a class="btn-link" href="all"><i class="bi bi-grid"></i> Ко всем фильмам</a>
  </div>
<?php endif; ?>
